...
pub fn x86_64_abi() -> SyscallABI {
    ...
    SyscallABI { arch: "x86_64", instruction: "syscall", id_reg: "rax", ret_reg: "rax", arg_regs: &["rdi", "rsi", "rdx", "r10", "r8", "r9"], clobbered: &["rcx", "r11"], sys_write: NATIVE_SYS_WRITE, sys_read: NATIVE_SYS_READ, sys_close: NATIVE_SYS_CLOSE, sys_exit: NATIVE_SYS_EXIT }
}
...
pub fn aarch64_abi() -> SyscallABI {
    ...
    SyscallABI { arch: "aarch64", instruction: "svc #0", id_reg: "x8", ret_reg: "x0", arg_regs: &["x0", "x1", "x2", "x3", "x4", "x5"], clobbered: &[], sys_write: NATIVE_SYS_WRITE, sys_read: NATIVE_SYS_READ, sys_close: NATIVE_SYS_CLOSE, sys_exit: NATIVE_SYS_EXIT }
}
...
pub fn riscv64_abi() -> SyscallABI {
    ...
    SyscallABI { arch: "riscv64", instruction: "ecall", id_reg: "a7", ret_reg: "a0", arg_regs: &["a0", "a1", "a2", "a3", "a4", "a5"], clobbered: &[], sys_write: NATIVE_SYS_WRITE, sys_read: NATIVE_SYS_READ, sys_close: NATIVE_SYS_CLOSE, sys_exit: NATIVE_SYS_EXIT }
}
...
pub unsafe fn syscall3(id: usize, arg0: usize, arg1: usize, arg2: usize) -> isize {
    ...
    core::arch::asm!(
        ...
        in("rsi") arg1,
        in("rdx") arg2,
        // can pass test without two lines below, but it will lead UB
        out("rcx") _,
        out("r11") _,
    );
    ret
...
pub fn sys_read(fd: usize, buf: &mut [u8]) -> isize {
    ...
    // arg2 should be more meaningful
...
pub fn sys_close(fd: usize) -> isize {
    ...
    // no need for arg1 and arg2
    unsafe {syscall3(NATIVE_SYS_CLOSE, fd, fd, fd)}
}

/// Terminate the current process.
pub fn sys_exit(code: i32) -> ! {
    // TODO: Call syscall3 to implement exit
    unsafe {syscall3(NATIVE_SYS_EXIT, code as usize, code as usize, code as usize)};
    panic!()
}
